...
function processFile(filepath) {
    ...
    // Replace the WhatsApp links with <button>
    // e.g. <a href="https://wa.me/19542341937" target="_blank" class="btn btn-primary">Request a Quote</a>
    const regex = /<a href="https:\/\/wa\.me\/19542341937" target="_blank" class="([^"]*)">(.*?)<\/a>/g;
    content = content.replace(regex, '<button class="$1 open-chatbot-btn">$2</button>');
...
console.log('Injected Chatbot successfully!');
